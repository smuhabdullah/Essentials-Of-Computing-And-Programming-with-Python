...
def cv2_to_pygame(cv_image):
    """
    Convert a CV2 image (ndarray) to a Pygame surface
    """
    ...
    pygame_surface = pygame.image.frombuffer(cv_image_rgb.flatten(), 
                                              cv_image_rgb.shape[1::-1], 
                                              'RGB')
...
def main(root):
    ...
    while True:
        ...
        pygame_surface = cv2_to_pygame(debug_image)
        root.blit(pygame_surface,(0,0))
        pygame.display.flip()
