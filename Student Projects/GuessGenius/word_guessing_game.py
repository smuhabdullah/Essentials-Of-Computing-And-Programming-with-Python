#We Are SCRIPT SQUAD:(Includes)
#1.Abdur-Rahman Naseem Shah
#2.M.Furqan
#3.M.Ishaq
...
lst5 = ["butterfly", "centipede", "grasshopper", "honeybee", "wasp", "earthworm", "termite", "spider", "leech",
        "locust", "mosquito"]

# Level 3 lists
lst6 = ["sanskrit", "english", "hindi", "mathematics", "chemistry", "physics", "astronomy", "economics", "history",
        "botany"]
lst7 = ["cricket", "football", "hockey", "baseball", "basketball", "billiard", "chess", "boxing", "wrestling", "polo",
        "tennis"]
lst8 = ["paper", "pencil", "compass", "crayon", "divider", "eraser", "file", "register", "magazine", "tape", "ruler",
        "slate", "glue", "colour", "sheet", "protractor"]

# Level 4 lists
lst9 = ["cinnamon", "menthol", "saffron", "cuminseed", "pepper", "cardamon", "raisin", "cashew", "chestnut", "almond",
        "date"]
lst10 = ["cookie", "pizza", "pudding", "porridge", "mayonnaise", "yogurt", "cornflake", "popcorn", "donut", "omelet",
         "riceball", "udon"]
lst11 = ["brinjal", "coriander", "cauliflower", "cucumber", "ginger", "jackfruit", "ladyfinger", "mushroom", "pumpkin",
         "spinach", "turnip", "tamarind", "onion", "radish", "gourd", "carrot", "cabbage", "garlic"]
...
def chooseWord(level, randomWords):  # randomWords is supplied so that the word should not be repeated.
    while True:
        ...
        if word in randomWords:  # Checks if the guessed word has already been used
            ...
            break  # else break
  # append the word into the list so it couldn't be used again
...
def gameComplete(score, correctAnswers, Total):  # Screen Up animation
    ...
    i= helpFont.render("i", True, black)
...
def startScreen():
    ...
    sExit = False
    helpLine1 = helpFont.render("Bro Read These Instructions (You can Understand this Easily!!):", True, yellow)
    ...
    helpLine01 = helpFont.render("We Are Sqcript Squad , Which Includes :", True, yellow)
    helpLine02 = helpFont.render(". Abdur-Rahman Naseem Shah", True, blue)
    helpLine03 = helpFont.render(". Muhammad.Furqan:", True, blue)
    helpLine04 = helpFont.render(". Muhammad.Ishaq", True, blue)


    quitGame = helpFont.render("Want to Quit the game!! Come Back Soon I'll Be Waiting For You:-(", True, red)
    i= helpFont.render("Looks Like !! You Want To Known About US : ", True, red)
    playGame = helpFont.render("Yeah ! Want to Play with me come on Challenge me!", True, green)
    #Making Buttons
    button1 = helpFont.render("Play", True, black)
    button2 = helpFont.render("Help", True, black)
    button3 = helpFont.render("Quit", True, black)
    button4 = helpFont.render("i", True, black)
    #aking Footer Title
    Heading1 =helpFont.render("Powered By : SCRIPT SQUAD ", True, white)
    Level1Start = wordGuessFont.render("LEVEL 1", True, green)
    # Making BG and displaying the heading
    ...
    while not sExit:
        ...
        if 100 + 100 > cur[0] > 100 and 200 + 50 > cur[1] > 200:
            ...
            gameDisplay.blit(playGame, [100, 300])
            if click[0] == 1:
        ...
        if 350 + 100 > cur[0] > 350 and 200 + 50 > cur[1] > 200:
            ...
            gameDisplay.blit(helpLine1, [25, 300])
        ...
        if 600 + 100 > cur[0] > 600 and 200 + 100 > cur[1] > 200:
            ...
            gameDisplay.blit(quitGame, [10, 300])
            if click[0] == 1:
                pygame.quit()
                quit()
        else:
        ...
        #i    
        if 760 + 560 > cur[0] > 760 and 560 + 50 > cur[1] > 200:
              pygame.draw.rect(gameDisplay, light_green, [760, 560, 30, 30])
              gameDisplay.blit(i, [150, 300])
              gameDisplay.blit(helpLine01, [25, 350])
              gameDisplay.blit(helpLine02, [25, 400])
              gameDisplay.blit(helpLine03, [25, 450])
              gameDisplay.blit(helpLine04, [25, 500])
            ...
            pygame.draw.rect(gameDisplay, green, [760, 560, 30, 30])
            #heading
        if 960 + 560 > cur[0] > 960 and 560 + 50 > cur[1] > 200:
              pygame.draw.rect(gameDisplay, light_green, [960, 560, 30, 30])
              gameDisplay.blit(Heading1, [150, 300])
        else:
            pygame.draw.rect(gameDisplay, green, [960, 560, 30, 30])
        ...
        gameDisplay.blit(button4, [770,555])
        gameDisplay.blit(Heading1, [200,555])
